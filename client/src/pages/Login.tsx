...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 p-4">
      <div className="w-full max-w-4xl flex overflow-hidden rounded-lg shadow-lg border border-neutral-200">
        <div className="hidden md:flex w-1/2 bg-primary-light items-center justify-center relative">
          ...
          <div className="z-10 text-white text-center p-8 max-w-md animate-[slideUp_0.5s_ease_forwards]">
            ...
            <p className="font-['Inter'] text-neutral-100 opacity-80">
              Access authentic items worn by your favorite celebrities. Every
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-8 bg-white">
          <div className="w-full max-w-md animate-[slideUp_0.5s_ease_forwards]">
            <div className="text-center mb-8">
              <h1 className="font-['Playfair_Display'] text-3xl md:text-4xl text-primary mb-2">
                Welcome Back
              </h1>
                    ...
                    <FormItem>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <Link
                          ...
                          className="text-xs text-[#6A0DAD] hover:underline"
                        >
                          Forgot password?
                        </Link>
                      </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-neutral-300 text-sm">
                ...
                <Link href="/signup">
                  <span className="text-[#6A0DAD] font-medium hover:underline ml-1">
                    Sign up
                  </span>
                </Link>
              </p>
