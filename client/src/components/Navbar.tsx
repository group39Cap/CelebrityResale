...
const Navbar = () => {
  ...
  // Calculate fixed navbar height
  const navbarHeight = 64; // 64px fixed height

  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-primary h-16 shadow-md">
      ...
      {/* Add a spacer div with the same height as the navbar to prevent content overlap */}
